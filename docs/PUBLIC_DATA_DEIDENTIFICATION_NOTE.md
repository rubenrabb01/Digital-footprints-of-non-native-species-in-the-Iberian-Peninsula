# Public data de-identification note

This public-release package uses de-identified YouTube-derived data. Direct YouTube video identifiers, video URLs, channel names, comment identifiers, and comment-author names have been replaced with stable internal labels or withheld in the CSV files included in the repository. The lookup table linking internal labels to original YouTube identifiers is not included.
