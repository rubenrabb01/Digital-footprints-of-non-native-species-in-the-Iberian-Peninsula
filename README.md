...
The folder `data_preparation_workflow/` documents the handoff from raw API outputs to manual screening and validated video files. It is optional for normal paper reproduction, but useful when starting from newly retrieved API outputs.
