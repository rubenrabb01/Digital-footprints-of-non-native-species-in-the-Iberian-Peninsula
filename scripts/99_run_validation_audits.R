...
#   - validation-summary figures for LABEL and keyword audits
...
if (file.exists("scripts/17_validation_summary_figures.R")) {
  source("scripts/17_validation_summary_figures.R", encoding = "UTF-8")
}
