...
files <- list(
  ...
  geo_anchor = file.path(root_dir, "data", "preparation_input", "api_geotagged_anchor_reconstructed.csv"),
...
cat("GEO-anchor / reconstructed RAW-GEO: 305 unique videos\n")
cat("final LABEL dataset: 1,899 rows; 1,895 unique videos\n\n")
