...
save_plot_safely <- function(plot, filename, width=185, height=175,
  ...
  # Export only the approved final Figure 2 / comments-only Fig. S6 with clean names.
  if (exists("ANALYSIS_MODE") && ANALYSIS_MODE == "COMMENTS_ONLY") {
    ...
    # Export only the paper-ready comments-only sensitivity figure: Supplementary Fig. S6.
    final_stems <- file.path(FIG_SUPP_DIR, "Figure_S6")
  } else {
