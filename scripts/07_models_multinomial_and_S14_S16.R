...
# ============================================================
# 07_models_multinomial_and_S14_S16.R
...
message("Running complete submitted Figures 4/S3/S6 + Tables 4/S14-S15 script: NO_COMMENTS")
  ...
  # ============================================================
  dir_tables_NO_COMMENTS <- "all_dataset_RAW_FLAGGED_IS_IBERIAN_tables/models_multinom"
  dir_plots_NO_COMMENTS  <- "all_dataset_RAW_FLAGGED_IS_IBERIAN_outputs_NEW_metrics_all/models_multinom"
  ...
  file.copy(
    file.path(dir_plots,"Figure4_A_single_NO_COMMENTS.png"),
    overwrite = TRUE
  )
  file.copy(
    file.path(dir_plots,"Figure4_B_single_NO_COMMENTS.png"),
    overwrite = TRUE
  )
  file.copy(
