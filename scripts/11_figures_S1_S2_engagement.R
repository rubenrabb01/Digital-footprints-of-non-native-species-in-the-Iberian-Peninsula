...
#   - Figure S2: (A) top uploads + dashed EC_adj rulers, (B) bubble
#   - Figure S3: (A) life-form uploads (icons), (B) life-form EC_adj (icons)
...
for (ext in c(".png", ".tiff")) {
  ...
  dst1 <- file.path(FIG_SUPP_DIR, paste0("Figure_S2", ext))
  ...
  dst2 <- file.path(FIG_SUPP_DIR, paste0("Figure_S3", ext))
